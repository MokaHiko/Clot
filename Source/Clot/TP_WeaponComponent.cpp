...
void UTP_WeaponComponent::Fire()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			...
			World->SpawnActor<AClotProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
		}
	}
...
void UTP_WeaponComponent::AttachWeapon(AClotCharacter* TargetCharacter)
{
...
{
	// Check that the character is valid, and has a rifle
	if (Character == nullptr || !Character->GetHasRifle())
	{
		return;
	}
